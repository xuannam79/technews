<?php
   ...
   $sql = "select n.*,c.name as 'catname', c.color as 'catcolor' from news n inner join cat c on n.cat_id=c.cat_id order by counter DESC limit $start,".($limit + 1);
   ...
   else // Ngược lại thì hiển thị bình thường. Trường hợp này dùng load trong file index
   {
      $total = count($result);
